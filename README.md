...
You can join our official [Telegram Chanel](https://t.me/awesomecstools) to stay up-to-date about any new tool added !
...
- [claude-hud](https://github.com/jarrodwatts/claude-hud): Claude Code plugin showing real-time context usage, active tools, spawned agents, and todos in a heads-up display.
...
- [Dify](https://github.com/langgenius/dify): Production-ready open-source platform for developing LLM applications. Combines agentic AI workflows, RAG pipelines, agent capabilities, model management, and observability. Features visual workflow builder, supports 100+ LLMs, 50+ built-in tools, and LLMOps monitoring.
...
- [OpenCLI](https://github.com/jackwener/OpenCLI): Turn any website into a CLI command for your AI agent — uses your logged-in browser session under the hood. Apache-2.0.
...
- [project-nomad](https://github.com/Crosstalk-Solutions/project-nomad): Offline survival computer packed with AI — runs local models anywhere with zero internet dependency.
- [OpenSandbox](https://github.com/alibaba/OpenSandbox): Alibaba's open-source secure sandbox runtime for AI agents — isolated Python/shell execution with resource limits, perfect for code-gen agent safety.
...
- [Qwen](https://chat.qwen.ai/): Alibaba AI ChatBot.
...
- [EdgeQuake](https://github.com/raphaelmansuy/edgequake): High-performance Rust GraphRAG framework for transforming documents into knowledge graphs for retrieval and generation.
...
- [NotFair](https://github.com/nowork-studio/NotFair): Open-source Claude Code skills for SEO, GEO, Google Ads, and Meta Ads. Covers [site SEO analysis, keyword research, meta tags, schema markup, and content writing](https://github.com/nowork-studio/NotFair/tree/main/seo), [Google Ads audits, wasted-spend detection, and bid management](https://github.com/nowork-studio/NotFair/tree/main/google-ads), and [Meta Ads ROAS, creative fatigue, and audience overlap analysis](https://github.com/nowork-studio/NotFair/tree/main/meta-ads). Connects live data through the Google Ads MCP, Meta Ads MCP, Google Search Console MCP, and Google Analytics (GA4) MCP. MIT licensed, ~2.9k stars.
