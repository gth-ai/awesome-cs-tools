...
- [Agency-Agents](https://github.com/msitarzewski/agency-agents): Library of production-ready AI expert persona configs for coding agents (Claude Code, Cursor, Copilot, Aider, Windsurf). 7K+ stars, MIT licensed.
